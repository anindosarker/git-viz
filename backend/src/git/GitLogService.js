...
class GitLogService {
    ...
    static async getLog(cwd) {
        ...
        try {
            const output = await GitExecutor_1.GitExecutor.exec(cwd, [
                "log",
...
exports.GitLogService = GitLogService;
//# sourceMappingURL=GitLogService.js.map